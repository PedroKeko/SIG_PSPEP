...
namespace SIG_PSPEP.Migrations
{
    ...
    public partial class _Inicial_1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "EfectividadeTipos",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DescTipo = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    Sigla = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EfectividadeTipos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MensagesAdmins", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "DispositivoMarcas",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MarcasDispositivo = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    Estado = table.Column<bool>(type: "bit", nullable: false),
                    DataRegisto = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DataUltimaAlterecao = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DispositivoMarcas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DispositivoMarcas_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "DispositivoTipos",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TiposDispositivo = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    Estado = table.Column<bool>(type: "bit", nullable: false),
                    DataRegisto = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DataUltimaAlterecao = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DispositivoTipos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DispositivoTipos_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LogsAcessos_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LogsEventos_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnoOrdemServico = table.Column<int>(type: "int", nullable: false),
                    Estado = table.Column<bool>(type: "bit", nullable: false),
                    DataRegisto = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DataUltimaAlterecao = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                name: "OrgUnidPnaMinints",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrgaoUnidadePrincipal = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NomeOrgaoUnidade = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Sigla = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Estado = table.Column<bool>(type: "bit", nullable: false),
                    DataRegisto = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrgUnidPnaMinints", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrgUnidPnaMinints_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Diuturnidade = table.Column<int>(type: "int", nullable: false),
                    Estado = table.Column<bool>(type: "bit", nullable: false),
                    DataRegisto = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DataUltimaAlterecao = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NumGuia = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    ...
                    ChefeId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Estado = table.Column<bool>(type: "bit", nullable: false),
                    DataRegisto = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DataUltimaAlterecao = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RadioGuias", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RadioGuias_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RadioTipos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RadioTipos_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "DispositivoModelos",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DispositivoMarcaId = table.Column<int>(type: "int", nullable: false),
                    Modelo = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    Estado = table.Column<bool>(type: "bit", nullable: false),
                    DataRegisto = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DataUltimaAlterecao = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DispositivoModelos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DispositivoModelos_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DispositivoModelos_DispositivoMarcas_DispositivoMarcaId",
                        column: x => x.DispositivoMarcaId,
                        principalTable: "DispositivoMarcas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RadioTipoId = table.Column<int>(type: "int", nullable: false),
                    CodRadio = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    IdRadio = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    TEI = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    NumSerie = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    EstadoTecnico = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    Estado = table.Column<bool>(type: "bit", nullable: false),
                    DataRegisto = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DataUltimaAlterecao = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Radios_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Radios_RadioTipos_RadioTipoId",
                        column: x => x.RadioTipoId,
                        principalTable: "RadioTipos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DispositivoTipoId = table.Column<int>(type: "int", nullable: false),
                    DispositivoMarcaId = table.Column<int>(type: "int", nullable: false),
                    DispositivoModeloId = table.Column<int>(type: "int", nullable: false),
                    Cod_Dispositivo = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ...
                    ROM = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    PROCESSADOR = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Estado = table.Column<bool>(type: "bit", nullable: false),
                    DataRegisto = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DataUltimaAlterecao = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dispositivos_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Dispositivos_DispositivoMarcas_DispositivoMarcaId",
                        column: x => x.DispositivoMarcaId,
                        principalTable: "DispositivoMarcas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Dispositivos_DispositivoModelos_DispositivoModeloId",
                        column: x => x.DispositivoModeloId,
                        principalTable: "DispositivoModelos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Dispositivos_DispositivoTipos_DispositivoTipoId",
                        column: x => x.DispositivoTipoId,
                        principalTable: "DispositivoTipos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                name: "RadioMovimentos",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RadioId = table.Column<int>(type: "int", nullable: false),
                    RadioGuiaId = table.Column<int>(type: "int", nullable: false),
                    OrgUnidPnaMinintId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RadioMovimentos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RadioMovimentos_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RadioMovimentos_OrgUnidPnaMinints_OrgUnidPnaMinintId",
                        column: x => x.OrgUnidPnaMinintId,
                        principalTable: "OrgUnidPnaMinints",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RadioMovimentos_RadioGuias_RadioGuiaId",
                        column: x => x.RadioGuiaId,
                        principalTable: "RadioGuias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RadioMovimentos_Radios_RadioId",
                        column: x => x.RadioId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstadoTecnico = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Estado = table.Column<bool>(type: "bit", nullable: false),
                    DataRegisto = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DataUltimaAlterecao = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DispositivoLocalizacoes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DispositivoLocalizacoes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DispositivoLocalizacoes_Dispositivos_DispositivoId",
                        column: x => x.DispositivoId,
                        principalTable: "Dispositivos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DispositivoLocalizacoes_OrgUnidPnaMinints_OrgUnidPnaMinintId",
                        column: x => x.OrgUnidPnaMinintId,
                        principalTable: "OrgUnidPnaMinints",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "EfectivoEfectividades",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EfectivoId = table.Column<int>(type: "int", nullable: false),
                    EfectividadeTipoId = table.Column<int>(type: "int", nullable: false),
                    DataPresenca = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EfectivoEfectividades", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EfectivoEfectividades_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EfectivoEfectividades_EfectividadeTipos_EfectividadeTipoId",
                        column: x => x.EfectividadeTipoId,
                        principalTable: "EfectividadeTipos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EfectivoEfectividades_Efectivos_EfectivoId",
                        column: x => x.EfectivoId,
                        principalTable: "Efectivos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EfectivoHistoricos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EfectivoHistoricos_Efectivos_EfectivoId",
                        column: x => x.EfectivoId,
                        principalTable: "Efectivos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EfectivoOrdemServicos_OrdemServicos_OrdemServicoId",
            ...
            migrationBuilder.CreateTable(
                name: "RadioMovimentoHistoricos",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RadioMovimentoId = table.Column<int>(type: "int", nullable: false),
                    DataEvento = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TipoHistorico = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Descricao = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RadioMovimentoHistoricos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RadioMovimentoHistoricos_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RadioMovimentoHistoricos_RadioMovimentos_RadioMovimentoId",
                        column: x => x.RadioMovimentoId,
                        principalTable: "RadioMovimentos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DispositivoLocalizacoes_DispositivoId",
                table: "DispositivoLocalizacoes",
                column: "DispositivoId");

            migrationBuilder.CreateIndex(
                name: "IX_DispositivoLocalizacoes_OrgUnidPnaMinintId",
                table: "DispositivoLocalizacoes",
                column: "OrgUnidPnaMinintId");

            migrationBuilder.CreateIndex(
                name: "IX_DispositivoLocalizacoes_UserId",
                table: "DispositivoLocalizacoes",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_DispositivoMarcas_UserId",
                table: "DispositivoMarcas",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_DispositivoModelos_DispositivoMarcaId",
                table: "DispositivoModelos",
                column: "DispositivoMarcaId");

            migrationBuilder.CreateIndex(
                name: "IX_DispositivoModelos_UserId",
                table: "DispositivoModelos",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Dispositivos_DispositivoMarcaId",
                table: "Dispositivos",
                column: "DispositivoMarcaId");

            migrationBuilder.CreateIndex(
                name: "IX_Dispositivos_DispositivoModeloId",
                table: "Dispositivos",
                column: "DispositivoModeloId");

            migrationBuilder.CreateIndex(
                name: "IX_Dispositivos_DispositivoTipoId",
                table: "Dispositivos",
                column: "DispositivoTipoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DispositivoTipos_UserId",
                table: "DispositivoTipos",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EfectivoEfectividades_EfectividadeTipoId",
                table: "EfectivoEfectividades",
                column: "EfectividadeTipoId");

            migrationBuilder.CreateIndex(
                name: "IX_EfectivoEfectividades_EfectivoId",
                table: "EfectivoEfectividades",
                column: "EfectivoId");

            migrationBuilder.CreateIndex(
                name: "IX_EfectivoEfectividades_UserId",
                table: "EfectivoEfectividades",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EfectivoHistoricos_EfectivoId",
                table: "EfectivoHistoricos",
                column: "EfectivoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EfectivoOrdemServicos_OrdemServicoId",
                table: "EfectivoOrdemServicos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LogsAcessos_UserId",
                table: "LogsAcessos",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_LogsEventos_UserId",
                table: "LogsEventos",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrgUnidPnaMinints_UserId",
                table: "OrgUnidPnaMinints",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RadioGuias_UserId",
                table: "RadioGuias",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_RadioMovimentoHistoricos_RadioMovimentoId",
                table: "RadioMovimentoHistoricos",
                column: "RadioMovimentoId");

            migrationBuilder.CreateIndex(
                name: "IX_RadioMovimentoHistoricos_UserId",
                table: "RadioMovimentoHistoricos",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_RadioMovimentos_OrgUnidPnaMinintId",
                table: "RadioMovimentos",
                column: "OrgUnidPnaMinintId");

            migrationBuilder.CreateIndex(
                name: "IX_RadioMovimentos_RadioGuiaId",
                table: "RadioMovimentos",
                column: "RadioGuiaId");

            migrationBuilder.CreateIndex(
                name: "IX_RadioMovimentos_RadioId",
                table: "RadioMovimentos",
                column: "RadioId");

            migrationBuilder.CreateIndex(
                name: "IX_RadioMovimentos_UserId",
                table: "RadioMovimentos",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Radios_RadioTipoId",
                table: "Radios",
                column: "RadioTipoId");
