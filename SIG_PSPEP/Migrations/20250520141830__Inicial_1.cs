        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TEI = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RadioOrgaoUnidades", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RadioOrgaoUnidades_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RadioOrgaoUnidades_OrgaoUnidades_OrgaoUnidadeId",
                        column: x => x.OrgaoUnidadeId,
                        principalTable: "OrgaoUnidades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RadioOrgaoUnidades_Radios_RadioId",
                        column: x => x.RadioId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DispositivoLocalizacoes_OrgaoUnidades_OrgaoUnidadeId",
                        column: x => x.OrgaoUnidadeId,
                        principalTable: "OrgaoUnidades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DispositivoLocalizacoes_OrgaoUnidadeId",
                table: "DispositivoLocalizacoes",
                column: "OrgaoUnidadeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RadioOrgaoUnidades_OrgaoUnidadeId",
                table: "RadioOrgaoUnidades",
                column: "OrgaoUnidadeId");

            migrationBuilder.CreateIndex(
                name: "IX_RadioOrgaoUnidades_RadioId",
                table: "RadioOrgaoUnidades",
                column: "RadioId");

            migrationBuilder.CreateIndex(
                name: "IX_RadioOrgaoUnidades_UserId",
                table: "RadioOrgaoUnidades",
                column: "UserId");
