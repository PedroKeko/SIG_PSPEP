...
public class BaseController : Controller
{
    ...
    protected bool UsuarioTemAcessoAAlgumaArea(params string[] areasPermitidas)
    {
        if (usuarioAute?.Area?.NomeArea == null)
            return false;

        return areasPermitidas.Any(area =>
            string.Equals(usuarioAute.Area.NomeArea.Trim(),
                          area.Trim(),
